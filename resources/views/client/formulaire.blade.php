    ...
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
          <h6 class="text-secondary text-uppercase mb-3 text-center">Contact</h6>
          <h1 class="mb-1 text-center text-uppercase">Contactez-nous</h1>
          <p class="text-secondary mb-5 text-center lead fs-4">Inscrivez-vous maintenant et économisez 10 % sur votre première commande !</p>
        </div>
      </div>
    </div>
